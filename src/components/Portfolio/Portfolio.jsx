...
class Portfolio extends Component {
        ...
        <div className="Portfolio__item__images">
          {item.images &&
            item.images.map((image, idx) =>
              this.renderImage(image, idx, item.imageContentStyle)
            )}
          {item.component &&
            this.renderComponent(item.component, item.imageStyle)}
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="Portfolio__item__image" key={idx}>
        <div
          ...
          style={{ backgroundImage: `url(${image})`, ...imageContentStyle }}
        />
      </div>
    )
  }
  ...
  renderComponent(component, style = {}) {
    ...
    return (
      <div className="Portfolio__item__image" style={style}>
        <Component />
      </div>
    )
  }
