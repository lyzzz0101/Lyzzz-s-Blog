    ...
    projects: [
      {
        ...
        description: (
          <div>
            <p>
              I teamed up with a friend on a game for people to play during the
              2020 United States Democratic Primary Debates. While they watched,
              users could click on a candidate's balloon when they agreed with
              what they were saying.
            </p>

            <p>
              At the end, we have a quantified metric for how well each
              candidate resonated with players. It was really fun to create an
              in-browser game, and figuring out the best ways to sync the game
              with an external video.
            </p>
          </div>
        ),
    ...
    projects: [
      ...
      },
      {
        ...
        description: (
          <div>
            <p>
              A brief dive into combining many metrics to decide what makes a
              country <b>Good</b>. There are three distinct visualizations here,
              exploring:
            </p>
            <List
      ...
      },
      {
        ...
        description: (
          <div>
            <p>
              Once code sketch a day, usually dealing with HTML canvas
              animations and quick generative art.
            </p>
          </div>
        ),
    ...
    projects: [
      {
        ...
        description: (
          <div>
            <p>
              There are many issues with how we receive our news (in the United
              States). I created a news aggregator (largely for personal use)
              that attempts to solve three core issues.
            </p>
            <List
              style={{ margin: "0 0 1em" }}
              items={[
                <>
                  <b style={{ display: "inline-block", marginBottom: "0.2em" }}>
                    Stories are often biased towards the viewpoint of a
                    political parties.
                  </b>
                  <br />
                  <b>Solution:</b> I aggregate stories from the most un-biased,
                  fact-based publishers (based on Ad Fontes Media's{" "}
                  <a href="https://www.adfontesmedia.com/" target="_blank">
                    Media Bias Chart
                  </a>
                  ).
                </>,
                <>
                  ...
                  <br />
                  <b>Solution:</b> I added a filter to hide stories with
                  specific words in their title or description.
                </>,
                <>
                  <b style={{ display: "inline-block", marginBottom: "0.2em" }}>
                    News stories are overwhelmingly sad and upsetting, which can
                    be compelling to avoid all news.
                  </b>
                  <br />
                  <b>Solution:</b> I added a sentiment filter so a reader can
                  only see stories within a specific range -- only happy
                  stories, or only sad stories (but why).
                </>,
              ]}
            />
          </div>
      ...
      // },
      {
        ...
        description: (
          <div>
            <p>
              In 2015, Umbel hosted an official SXSW party (with Spoon!). To
              incorporate our brand and liven up the VIP section, I build a
              virtual photobooth that superimposes a luchador mask on guests’
              faces.
            </p>
            <p>
              I built a C++ app that detects faces from a webcam feed in
              real-time and renders a mask over anything that looks like a face
              (based on some training data). The face is broken into sections,
              and the mask is stretched to fit the different parts of the face,
              which makes it pretty realistic, even when someone is talking. The
              user can use a foot pedal to either cycle through the faces or
              take a picture.
            </p>
            <p>
              If you look closely, you can see people’s concentration as they
              try to balance and take a picture. Additionally, I built a web app
              to show the photos in real-time and allow people to share on
              social media.
            </p>
            <p>
              Read more about the construction{" "}
              <a href="https://www.umbel.com/engineering/blog/wrestling-ring">
                on the Umbel Engineering blog
              </a>
              .
            </p>
          </div>
